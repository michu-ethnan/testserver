Feature: Apply sort, filter and select page

  Scenario: apply sort, apply two filters, select page, open pdp and return - category page
  ...
  Scenario: apply sort, apply two filters, select page, open pdp and return - search page
