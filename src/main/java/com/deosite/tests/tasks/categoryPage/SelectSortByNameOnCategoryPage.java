...
public class SelectSortByNameOnCategoryPage implements Task {
    String appliedFilter;
    private final String sortName;
    public SelectSortByNameOnCategoryPage(String sortName){
    ...
    public static SelectSortByNameOnCategoryPage byName(String sortName) {
        return Instrumented.instanceOf(SelectSortByNameOnCategoryPage.class).withProperties(sortName);
    }
}
