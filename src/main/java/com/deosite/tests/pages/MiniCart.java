...
public class MiniCart {
    ...
    public static Target EMPTY_CART_MESSAGE = Target.the("Empty cart message").locatedBy("//*[@id=\"__layers__\"]/div/div[2]/div/div[2]/div/div/div/div[1]/div[2]/div/span[2]");
    public static Target MINICART_BUTTON = Target.the("Minicart button").locatedBy("(//div[@data-test='mini-cart'])[1]/button");
    ...
    public static Target TOTAL_SUM = Target.the("Total sum in minicart").locatedBy("//*[@id=\"__layers__\"]/div/div[2]/div/div[2]/div/div/div/div[1]/div[2]/div/div/div[4]/div/div/div[2]/span/span[1]");
