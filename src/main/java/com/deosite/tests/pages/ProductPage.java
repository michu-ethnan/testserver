...
public class ProductPage {
    ...
    public static Target PRODUCT_PRICE = Target.the("Product price").locatedBy("(//*[@id=\"__app__\"]//h1/../div//p/span/span)[1]");
    public static Target DISCOUNTED_PRODUCT_PRICE = Target.the("Discounted Product price").locatedBy("(//*[@id=\"__app__\"]//h1/../div//p[2]/span/span)[1]");
