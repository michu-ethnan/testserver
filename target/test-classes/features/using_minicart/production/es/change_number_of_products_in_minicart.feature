Feature: Change the number of products in minicart ES
  ...
  Scenario: Should change the number of products in minicart
    ...
    Given that Laura has a Jardín in the cart on ES
    When she tries to increase the number of products
    Then she should see that the number is greater_ES
    ...
    Scenario: Should change the number of products in minicart
      ...
      Then she should see that the number is smaller_ES